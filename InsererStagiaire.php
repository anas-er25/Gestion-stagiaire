...
if (isset($_POST['ajout'])) {
    ...
    $stmt = $db->prepare('INSERT INTO stagiaire (nom, prenom, dateNaissance, photoProfil, idFiliere) VALUES (?, ?, ?, ?, ?)');
    $exec=$stmt->execute([$name, $lastname, $datenaissance, $destination, $filiere]);
    if($exec){
    ...
    <div class="container">
        ...
        <form class="was-validated" method="post" enctype="multipart/form-data">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="name" id="validation" placeholder="Saisir le nom" required></input>

            </div>
            <div class="mb-3">
                <label for="validationPrenom" class="form-label">Prenom</label>
                <input type="text" class="form-control" name="lastname" id="validation" placeholder="Saisir le prenom" required></input>

            </div>
            <div class="mb-3">
                <label for="validationDateNaissance" class="form-label">Date de Naissance</label>
                <input type="date" class="form-control" name="datenaissance" id="validation" placeholder="Saisir la date de naissance" required></input>
